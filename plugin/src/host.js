...
// 由动态插件 host-v10.js 移植：
//  - 业务逻辑与 host-v10.js 完全一致（余额真实 API / 峰谷定价 / llm/stream 记账 / 会话聚合 / 显示名识别）
//  - 差异：RPC 由动态沙箱的 harness.handle 改为 webServer HTTP 路由
//    （GET/POST /_dsh/bottom-info-bar/<method>，JSON 进出，同源防护）
