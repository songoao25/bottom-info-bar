...
check('模型切换使用克制的短动效，且尊重减少动态效果偏好', client.includes('@keyframes bi-model-transition')
  && client.includes('animation: bi-model-transition 160ms cubic-bezier(0.2, 0.8, 0.2, 1) both')
  && client.includes('@media (prefers-reduced-motion: reduce) { .bi-model-transition { animation: none; } }'))
